...
<body>
    ...
    <div>
        <main class="tm-main main-register">
            ...
            <div class="container">
                <form action="./includes/register/register.inc.php" method="post" enctype="multipart/form-data" class="mb-5 ml-auto mr-0 login-form">
                    ...
                    <div class="form-group row mb-4">
                        <label for="profile-pic" id="profile-pic-label" class="col-sm-3 col-form-label tm-color-primary">Profile Picture</label>
                        <div class="col-sm-9">
                            <div class="input-i">
                                <input class="form-control mr-0 ml-auto" name="profile-pic" id="profile-pic" type="file" accept=".jpg, .jpeg, .png" onchange="previewImagePlusValid(event)">
                            ...
                            <div class="image-container">
                                <img src="#" id="image-preview" alt="Preview" class="img-thumbnail" style="max-width: 100%; max-height: 150px; margin-top: 10px;border-radius:100px;display: none;">
                    ...
                    <div class="form-group row mb-4">
                        <label id="password-label" for="password" class="col-sm-3 col-form-label tm-color-primary">Password*</label>
                        <div class="col-sm-9">
                            <div class="input-i">
                                <input class="form-control mr-0 ml-auto" name="password" id="password" type="password" autocomplete="new-password" required>
                                <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="
                    ...
                    <div class="form-group row mb-4">
                        <label id="cnfm-password-label" for="cnfm-password" class="col-sm-3 col-form-label tm-color-primary">Confirm Password*</label>
                        <div class="col-sm-9">
                            <div class="input-i">
                                <input class="form-control mr-0 ml-auto" name="cnfm-password" id="cnfm-password" type="password" autocomplete="new-password" required>
                                <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="The Confirm Password must be the same as the Password"></i>
                            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <button class="tm-btn tm-btn-primary tm-btn-small" id="register-btn" type="submit">Register</button>
                        </div>
                    </div>
